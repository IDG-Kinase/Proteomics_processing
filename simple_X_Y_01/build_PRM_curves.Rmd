...
deep_dive_data = process_excel_sheet(here('simple_X_Y_01/Deep Dive kinome plot data 022019-2.xlsx'),sheet = 1)

for (i in 2:length(excel_sheets(here('simple_X_Y_01/Deep Dive kinome plot data 022019-2.xlsx')))) {
  deep_dive_data = rbind(deep_dive_data,
                         process_excel_sheet(here('simple_X_Y_01/Deep Dive kinome plot data 022019-2.xlsx'),sheet = i))
}
```

```{r read_in_curve_summary}
curve_summary = read_excel(here('simple_X_Y_01/Deep Dive kinome Peptide parameters 022019.xlsx'),skip=1) %>%
  clean_names() %>%
...
write_csv(curve_info,here('simple_X_Y_01/PRM_curve_data.csv'))
```